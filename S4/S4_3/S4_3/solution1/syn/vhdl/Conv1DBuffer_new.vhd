...
architecture behav of Conv1DBuffer_new is 
    ...
    signal exitcond_flatten4_reg_401 : STD_LOGIC_VECTOR (0 downto 0);
    signal ptr_simd_reg_139 : STD_LOGIC_VECTOR (8 downto 0);
    signal indvar_flatten4_reg_151 : STD_LOGIC_VECTOR (19 downto 0);
    signal op1_assign_reg_162 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal ptr_simd_1_reg_396 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal exitcond_flatten4_fu_241_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state5_pp1_stage0_iter0 : BOOLEAN;
    signal ap_block_state6_pp1_stage0_iter1 : BOOLEAN;
    signal ap_block_pp1_stage0_11001 : BOOLEAN;
    signal indvar_flatten_next4_fu_247_p2 : STD_LOGIC_VECTOR (19 downto 0);
    signal ap_enable_reg_pp1_iter0 : STD_LOGIC := '0';
    signal op1_assign_mid2_fu_311_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_4_fu_223_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_6_fu_229_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_flatten_fu_253_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ofm_iter_fu_267_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_4_mid1_fu_273_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_cond_fu_235_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal not_exitcond_flatten_fu_287_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_54_fu_299_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_mid_fu_259_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_7_mid_fu_305_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_9_fu_325_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_2_fu_319_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_4_mid2_fu_279_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_6_mid1_fu_339_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((exitcond_flatten4_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
                indvar_flatten4_reg_151 <= indvar_flatten_next4_fu_247_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                exitcond_flatten4_reg_401 <= exitcond_flatten4_fu_241_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten4_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                inputBuf_0_V_addr_1_reg_424 <= tmp_8_fu_367_p1(8 - 1 downto 0);
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, tmp_fu_206_p2, ap_enable_reg_pp0_iter0, exitcond_flatten4_fu_241_p2, ap_enable_reg_pp1_iter0, ap_block_pp0_stage0_subdone, ap_block_pp1_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp1_stage0 => 
                if (not(((exitcond_flatten4_fu_241_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif (((exitcond_flatten4_fu_241_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone))) then
    ...
    ap_block_pp1_stage0_01001_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten4_reg_401)
    begin
                ap_block_pp1_stage0_01001 <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten4_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp1_stage0_11001_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten4_reg_401)
    begin
                ap_block_pp1_stage0_11001 <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten4_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp1_stage0_subdone_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten4_reg_401)
    begin
                ap_block_pp1_stage0_subdone <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten4_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;
    ...
    ap_block_state6_pp1_stage0_iter1_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, or_cond_mid2_reg_415, exitcond_flatten4_reg_401)
    begin
                ap_block_state6_pp1_stage0_iter1 <= (((exitcond_flatten4_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0)));
    end process;
    ...
    ap_condition_pp1_exit_iter0_state5_assign_proc : process(exitcond_flatten4_fu_241_p2)
    begin
        if ((exitcond_flatten4_fu_241_p2 = ap_const_lv1_1)) then 
    ...
    exitcond_flatten4_fu_241_p2 <= "1" when (indvar_flatten4_reg_151 = ap_const_lv20_80000) else "0";
    exitcond_flatten_fu_253_p2 <= "1" when (indvar_flatten_reg_173 = ap_const_lv16_4000) else "0";
    ...
    indvar_flatten_next4_fu_247_p2 <= std_logic_vector(unsigned(indvar_flatten4_reg_151) + unsigned(ap_const_lv20_1));
    indvar_flatten_next_fu_384_p3 <= 
        ap_const_lv16_1 when (exitcond_flatten_fu_253_p2(0) = '1') else 
    ...
    inputBuf_0_V_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter0, tmp_s_fu_218_p1, tmp_8_fu_367_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
            inputBuf_0_V_address0 <= tmp_8_fu_367_p1(8 - 1 downto 0);
    ...
    nm_2_fu_319_p2 <= std_logic_vector(unsigned(nm_mid_fu_259_p3) + unsigned(ap_const_lv7_1));
    nm_mid2_fu_359_p3 <= 
        nm_2_fu_319_p2 when (tmp_7_mid_fu_305_p2(0) = '1') else 
        nm_mid_fu_259_p3;
    nm_mid_fu_259_p3 <= 
        ap_const_lv7_0 when (exitcond_flatten_fu_253_p2(0) = '1') else 
        nm_reg_184;
    not_exitcond_flatten_fu_287_p2 <= (exitcond_flatten_fu_253_p2 xor ap_const_lv1_1);
    ofm_iter_fu_267_p2 <= std_logic_vector(unsigned(op1_assign_reg_162) + unsigned(ap_const_lv6_1));
    op1_assign_mid2_fu_311_p3 <= 
        ofm_iter_fu_267_p2 when (exitcond_flatten_fu_253_p2(0) = '1') else 
        op1_assign_reg_162;
    or_cond_fu_235_p2 <= (tmp_6_fu_229_p2 and tmp_4_fu_223_p2);
    or_cond_mid1_fu_345_p2 <= (tmp_6_mid1_fu_339_p2 and tmp_4_mid2_fu_279_p3);
    or_cond_mid2_fu_351_p3 <= 
        or_cond_mid1_fu_345_p2 when (tmp_7_mid_fu_305_p2(0) = '1') else 
        or_cond_mid_fu_293_p2;
    or_cond_mid_fu_293_p2 <= (or_cond_fu_235_p2 and not_exitcond_flatten_fu_287_p2);

    out_V_V_blk_n_assign_proc : process(out_V_V_full_n, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, ap_block_pp1_stage0, exitcond_flatten4_reg_401)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (exitcond_flatten4_reg_401 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
    ...
    out_V_V_write_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, exitcond_flatten4_reg_401, ap_block_pp1_stage0_11001)
    begin
        if (((exitcond_flatten4_reg_401 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
    ...
    ptr_simd4_mid2_fu_331_p3 <= 
        ap_const_lv9_0 when (tmp_9_fu_325_p2(0) = '1') else 
        ptr_simd4_reg_195;
    ptr_simd_1_fu_212_p2 <= std_logic_vector(unsigned(ap_phi_mux_ptr_simd_phi_fu_143_p4) + unsigned(ap_const_lv9_1));
    ptr_simd_2_fu_372_p2 <= std_logic_vector(unsigned(ptr_simd4_mid2_fu_331_p3) + unsigned(ap_const_lv9_1));
    ...
    tmp_4_fu_223_p2 <= "1" when (unsigned(op1_assign_reg_162) < unsigned(ap_const_lv6_1F)) else "0";
    tmp_4_mid1_fu_273_p2 <= "1" when (unsigned(ofm_iter_fu_267_p2) < unsigned(ap_const_lv6_1F)) else "0";
    tmp_4_mid2_fu_279_p3 <= 
        tmp_4_mid1_fu_273_p2 when (exitcond_flatten_fu_253_p2(0) = '1') else 
        tmp_4_fu_223_p2;
    tmp_54_fu_299_p2 <= "1" when (ptr_simd4_reg_195 = ap_const_lv9_100) else "0";
    tmp_6_fu_229_p2 <= "1" when (nm_reg_184 = ap_const_lv7_3F) else "0";
    tmp_6_mid1_fu_339_p2 <= "1" when (nm_2_fu_319_p2 = ap_const_lv7_3F) else "0";
    tmp_7_mid_fu_305_p2 <= (tmp_54_fu_299_p2 and not_exitcond_flatten_fu_287_p2);
    tmp_8_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ptr_simd4_mid2_fu_331_p3),64));
    tmp_9_fu_325_p2 <= (tmp_7_mid_fu_305_p2 or exitcond_flatten_fu_253_p2);
