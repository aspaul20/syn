...
reg    out_V_V_blk_n;
reg   [0:0] exitcond_flatten4_reg_401;
reg   [8:0] ptr_simd_reg_139;
reg   [19:0] indvar_flatten4_reg_151;
reg   [5:0] op1_assign_reg_162;
...
wire   [0:0] exitcond_flatten4_fu_241_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [19:0] indvar_flatten_next4_fu_247_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [5:0] op1_assign_mid2_fu_311_p3;
...
wire   [0:0] tmp_4_fu_223_p2;
wire   [0:0] tmp_6_fu_229_p2;
wire   [0:0] exitcond_flatten_fu_253_p2;
wire   [5:0] ofm_iter_fu_267_p2;
wire   [0:0] tmp_4_mid1_fu_273_p2;
wire   [0:0] or_cond_fu_235_p2;
wire   [0:0] not_exitcond_flatten_fu_287_p2;
wire   [0:0] tmp_54_fu_299_p2;
wire   [6:0] nm_mid_fu_259_p3;
wire   [0:0] tmp_7_mid_fu_305_p2;
wire   [0:0] tmp_9_fu_325_p2;
wire   [6:0] nm_2_fu_319_p2;
wire   [0:0] tmp_4_mid2_fu_279_p3;
wire   [0:0] tmp_6_mid1_fu_339_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        indvar_flatten4_reg_151 <= 20'd0;
    end else if (((exitcond_flatten4_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten4_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        inputBuf_0_V_addr_1_reg_424 <= tmp_8_fu_367_p1;
...
always @ (*) begin
    if ((exitcond_flatten4_fu_241_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        inputBuf_0_V_address0 = tmp_8_fu_367_p1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (exitcond_flatten4_reg_401 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((exitcond_flatten4_reg_401 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        out_V_V_write = 1'b1;
    end else begin
        out_V_V_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((exitcond_flatten4_fu_241_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((exitcond_flatten4_fu_241_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_flatten4_reg_401 == 1'd0) & (out_V_V_full_n == 1'b0)) | ((or_cond_mid2_reg_415 == 1'd1) & (in_V_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_flatten4_reg_401 == 1'd0) & (out_V_V_full_n == 1'b0)) | ((or_cond_mid2_reg_415 == 1'd1) & (in_V_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((exitcond_flatten4_reg_401 == 1'd0) & (out_V_V_full_n == 1'b0)) | ((or_cond_mid2_reg_415 == 1'd1) & (in_V_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((exitcond_flatten4_reg_401 == 1'd0) & (out_V_V_full_n == 1'b0)) | ((or_cond_mid2_reg_415 == 1'd1) & (in_V_V_empty_n == 1'b0)));
end
...
assign exitcond_flatten4_fu_241_p2 = ((indvar_flatten4_reg_151 == 20'd524288) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_253_p2 = ((indvar_flatten_reg_173 == 16'd16384) ? 1'b1 : 1'b0);

assign indvar_flatten_next4_fu_247_p2 = (indvar_flatten4_reg_151 + 20'd1);
...
assign nm_mid2_fu_359_p3 = ((tmp_7_mid_fu_305_p2[0:0] === 1'b1) ? nm_2_fu_319_p2 : nm_mid_fu_259_p3);
...
assign ofm_iter_fu_267_p2 = (op1_assign_reg_162 + 6'd1);

assign op1_assign_mid2_fu_311_p3 = ((exitcond_flatten_fu_253_p2[0:0] === 1'b1) ? ofm_iter_fu_267_p2 : op1_assign_reg_162);

assign or_cond_fu_235_p2 = (tmp_6_fu_229_p2 & tmp_4_fu_223_p2);

assign or_cond_mid1_fu_345_p2 = (tmp_6_mid1_fu_339_p2 & tmp_4_mid2_fu_279_p3);

assign or_cond_mid2_fu_351_p3 = ((tmp_7_mid_fu_305_p2[0:0] === 1'b1) ? or_cond_mid1_fu_345_p2 : or_cond_mid_fu_293_p2);

assign or_cond_mid_fu_293_p2 = (or_cond_fu_235_p2 & not_exitcond_flatten_fu_287_p2);

assign out_V_V_din = inputBuf_0_V_q0;

assign ptr_simd4_mid2_fu_331_p3 = ((tmp_9_fu_325_p2[0:0] === 1'b1) ? 9'd0 : ptr_simd4_reg_195);
...
assign tmp_4_fu_223_p2 = ((op1_assign_reg_162 < 6'd31) ? 1'b1 : 1'b0);

assign tmp_4_mid1_fu_273_p2 = ((ofm_iter_fu_267_p2 < 6'd31) ? 1'b1 : 1'b0);

assign tmp_4_mid2_fu_279_p3 = ((exitcond_flatten_fu_253_p2[0:0] === 1'b1) ? tmp_4_mid1_fu_273_p2 : tmp_4_fu_223_p2);

assign tmp_54_fu_299_p2 = ((ptr_simd4_reg_195 == 9'd256) ? 1'b1 : 1'b0);

assign tmp_6_fu_229_p2 = ((nm_reg_184 == 7'd63) ? 1'b1 : 1'b0);

assign tmp_6_mid1_fu_339_p2 = ((nm_2_fu_319_p2 == 7'd63) ? 1'b1 : 1'b0);

assign tmp_7_mid_fu_305_p2 = (tmp_54_fu_299_p2 & not_exitcond_flatten_fu_287_p2);

assign tmp_8_fu_367_p1 = ptr_simd4_mid2_fu_331_p3;

assign tmp_9_fu_325_p2 = (tmp_7_mid_fu_305_p2 | exitcond_flatten_fu_253_p2);
