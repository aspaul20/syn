...
architecture behav of Conv1DBuffer_new is 
    ...
    signal exitcond_flatten2_reg_401 : STD_LOGIC_VECTOR (0 downto 0);
    signal ptr_simd_reg_139 : STD_LOGIC_VECTOR (8 downto 0);
    signal indvar_flatten2_reg_151 : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal exitcond_flatten2_fu_241_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state5_pp1_stage0_iter0 : BOOLEAN;
    signal ap_block_state6_pp1_stage0_iter1 : BOOLEAN;
    signal ap_block_pp1_stage0_11001 : BOOLEAN;
    signal indvar_flatten_next2_fu_247_p2 : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal tmp_12_fu_367_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp1_stage0_01001 : BOOLEAN;
    signal tmp_8_fu_223_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_10_fu_229_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_flatten_fu_253_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ofm_iter_fu_267_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_8_mid1_fu_273_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_cond_fu_235_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal not_exitcond_flatten_fu_287_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_32_fu_299_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_mid_fu_259_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_11_mid_fu_305_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_13_fu_325_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_2_fu_319_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_8_mid2_fu_279_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_10_mid1_fu_339_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((exitcond_flatten2_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
                indvar_flatten2_reg_151 <= indvar_flatten_next2_fu_247_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                exitcond_flatten2_reg_401 <= exitcond_flatten2_fu_241_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten2_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                inputBuf_0_V_addr_1_reg_424 <= tmp_12_fu_367_p1(8 - 1 downto 0);
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, tmp_fu_206_p2, ap_enable_reg_pp0_iter0, exitcond_flatten2_fu_241_p2, ap_enable_reg_pp1_iter0, ap_block_pp0_stage0_subdone, ap_block_pp1_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp1_stage0 => 
                if (not(((exitcond_flatten2_fu_241_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif (((exitcond_flatten2_fu_241_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone))) then
    ...
    ap_block_pp1_stage0_01001_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten2_reg_401)
    begin
                ap_block_pp1_stage0_01001 <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten2_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp1_stage0_11001_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten2_reg_401)
    begin
                ap_block_pp1_stage0_11001 <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten2_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp1_stage0_subdone_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten2_reg_401)
    begin
                ap_block_pp1_stage0_subdone <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten2_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;
    ...
    ap_block_state6_pp1_stage0_iter1_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, or_cond_mid2_reg_415, exitcond_flatten2_reg_401)
    begin
                ap_block_state6_pp1_stage0_iter1 <= (((exitcond_flatten2_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0)));
    end process;
    ...
    ap_condition_pp1_exit_iter0_state5_assign_proc : process(exitcond_flatten2_fu_241_p2)
    begin
        if ((exitcond_flatten2_fu_241_p2 = ap_const_lv1_1)) then 
    ...
    exitcond_flatten2_fu_241_p2 <= "1" when (indvar_flatten2_reg_151 = ap_const_lv24_800000) else "0";
    ...
    indvar_flatten_next2_fu_247_p2 <= std_logic_vector(unsigned(indvar_flatten2_reg_151) + unsigned(ap_const_lv24_1));
    ...
    inputBuf_0_V_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter0, tmp_s_fu_218_p1, tmp_12_fu_367_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
            inputBuf_0_V_address0 <= tmp_12_fu_367_p1(8 - 1 downto 0);
    ...
    nm_mid2_fu_359_p3 <= 
        nm_2_fu_319_p2 when (tmp_11_mid_fu_305_p2(0) = '1') else 
        nm_mid_fu_259_p3;
    nm_mid_fu_259_p3 <= 
    ...
    ofm_iter_fu_267_p2 <= std_logic_vector(unsigned(op1_assign_reg_162) + unsigned(ap_const_lv10_1));
    op1_assign_mid2_fu_311_p3 <= 
        ofm_iter_fu_267_p2 when (exitcond_flatten_fu_253_p2(0) = '1') else 
        op1_assign_reg_162;
    or_cond_fu_235_p2 <= (tmp_8_fu_223_p2 and tmp_10_fu_229_p2);
    or_cond_mid1_fu_345_p2 <= (tmp_8_mid2_fu_279_p3 and tmp_10_mid1_fu_339_p2);
    or_cond_mid2_fu_351_p3 <= 
        or_cond_mid1_fu_345_p2 when (tmp_11_mid_fu_305_p2(0) = '1') else 
        or_cond_mid_fu_293_p2;
    or_cond_mid_fu_293_p2 <= (or_cond_fu_235_p2 and not_exitcond_flatten_fu_287_p2);

    out_V_V_blk_n_assign_proc : process(out_V_V_full_n, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, ap_block_pp1_stage0, exitcond_flatten2_reg_401)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (exitcond_flatten2_reg_401 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
    ...
    out_V_V_write_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, exitcond_flatten2_reg_401, ap_block_pp1_stage0_11001)
    begin
        if (((exitcond_flatten2_reg_401 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
    ...
    ptr_simd4_mid2_fu_331_p3 <= 
        ap_const_lv9_0 when (tmp_13_fu_325_p2(0) = '1') else 
        ptr_simd4_reg_195;
    ...
    tmp_10_fu_229_p2 <= "1" when (nm_reg_184 = ap_const_lv7_3F) else "0";
    tmp_10_mid1_fu_339_p2 <= "1" when (nm_2_fu_319_p2 = ap_const_lv7_3F) else "0";
    tmp_11_mid_fu_305_p2 <= (tmp_32_fu_299_p2 and not_exitcond_flatten_fu_287_p2);
    tmp_12_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ptr_simd4_mid2_fu_331_p3),64));
    tmp_13_fu_325_p2 <= (tmp_11_mid_fu_305_p2 or exitcond_flatten_fu_253_p2);
    tmp_32_fu_299_p2 <= "1" when (ptr_simd4_reg_195 = ap_const_lv9_100) else "0";
    tmp_8_fu_223_p2 <= "1" when (unsigned(op1_assign_reg_162) < unsigned(ap_const_lv10_1FF)) else "0";
    tmp_8_mid1_fu_273_p2 <= "1" when (unsigned(ofm_iter_fu_267_p2) < unsigned(ap_const_lv10_1FF)) else "0";
    tmp_8_mid2_fu_279_p3 <= 
        tmp_8_mid1_fu_273_p2 when (exitcond_flatten_fu_253_p2(0) = '1') else 
        tmp_8_fu_223_p2;
