...
architecture behav of StreamingDataWidthCo_1 is 
    ...
    signal t_reg_110 : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal t_1_fu_137_p2 : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal tmp_4_fu_155_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    exitcond_fu_131_p2 <= "1" when (t_reg_110 = ap_const_lv18_20000) else "0";
    ...
    p_s_fu_161_p3 <= 
        ap_const_lv32_0 when (tmp_4_fu_155_p2(0) = '1') else 
        o_1_fu_149_p2;
    ...
    t_1_fu_137_p2 <= std_logic_vector(unsigned(t_reg_110) + unsigned(ap_const_lv18_1));
    tmp_4_fu_155_p2 <= "1" when (o_1_fu_149_p2 = ap_const_lv32_4) else "0";
