...
const sc_lv<18> StreamingDataWidthCo_1::ap_const_lv18_0 = "000000000000000000";
const sc_lv<18> StreamingDataWidthCo_1::ap_const_lv18_20000 = "100000000000000000";
const sc_lv<18> StreamingDataWidthCo_1::ap_const_lv18_1 = "1";
...
StreamingDataWidthCo_1::StreamingDataWidthCo_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_4_fu_155_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( exitcond_fu_131_p2 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    ...
    sc_trace(mVcdFile, tmp_4_fu_155_p2, "tmp_4_fu_155_p2");
...
void StreamingDataWidthCo_1::thread_exitcond_fu_131_p2() {
    exitcond_fu_131_p2 = (!t_reg_110.read().is_01() || !ap_const_lv18_20000.is_01())? sc_lv<1>(): sc_lv<1>(t_reg_110.read() == ap_const_lv18_20000);
}
...
void StreamingDataWidthCo_1::thread_p_s_fu_161_p3() {
    p_s_fu_161_p3 = (!tmp_4_fu_155_p2.read()[0].is_01())? sc_lv<32>(): ((tmp_4_fu_155_p2.read()[0].to_bool())? ap_const_lv32_0: o_1_fu_149_p2.read());
}
...
void StreamingDataWidthCo_1::thread_t_1_fu_137_p2() {
    t_1_fu_137_p2 = (!t_reg_110.read().is_01() || !ap_const_lv18_1.is_01())? sc_lv<18>(): (sc_biguint<18>(t_reg_110.read()) + sc_biguint<18>(ap_const_lv18_1));
}

void StreamingDataWidthCo_1::thread_tmp_4_fu_155_p2() {
    tmp_4_fu_155_p2 = (!o_1_fu_149_p2.read().is_01() || !ap_const_lv32_4.is_01())? sc_lv<1>(): sc_lv<1>(o_1_fu_149_p2.read() == ap_const_lv32_4);
}
