...
input  [31:0] outPtr_V;
output  [31:0] outPtr_V_out_din;
input   outPtr_V_out_full_n;
output   outPtr_V_out_write;

reg ap_done;
reg ap_idle;
reg start_write;
reg out_V_V_write;
reg outPtr_V_out_write;
...
reg    out_V_V_blk_n;
reg    outPtr_V_out_blk_n;
wire   [18:0] i_fu_112_p2;
reg   [18:0] i_reg_126;
wire    ap_CS_fsm_state2;
reg   [18:0] i_i_i_reg_95;
reg    ap_block_state1;
reg    ap_block_state3;
wire   [0:0] tmp_i_i_fu_106_p2;
reg   [2:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((tmp_i_i_fu_106_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((real_start == 1'b0) | (outPtr_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_i_i_reg_95 <= 19'd0;
    end
end
...
always @ (*) begin
    if (((tmp_i_i_fu_106_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        outPtr_V_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((real_start == 1'b0) | (outPtr_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        outPtr_V_out_write = 1'b1;
    end else begin
        outPtr_V_out_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (outPtr_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign i_fu_112_p2 = (i_i_i_reg_95 + 19'd1);
...
assign outPtr_V_out_din = outPtr_V;

assign out_V_V_din = in_V_V_0_data_out[7:0];

assign start_out = real_start;

assign tmp_i_i_fu_106_p2 = ((i_i_i_reg_95 == 19'd262144) ? 1'b1 : 1'b0);

endmodule //ResizeStream_14
