...
architecture behav of ResizeStream_14 is 
    ...
    signal outPtr_V_out_blk_n : STD_LOGIC;
    signal i_fu_112_p2 : STD_LOGIC_VECTOR (18 downto 0);
    signal i_reg_126 : STD_LOGIC_VECTOR (18 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal i_i_i_reg_95 : STD_LOGIC_VECTOR (18 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal ap_block_state3 : BOOLEAN;
    signal tmp_i_i_fu_106_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((tmp_i_i_fu_106_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((in_V_V_0_vld_out = ap_const_logic_0) or (out_V_V_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                i_i_i_reg_95 <= i_reg_126;
            elsif ((not(((real_start = ap_const_logic_0) or (outPtr_V_out_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                i_i_i_reg_95 <= ap_const_lv19_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, in_V_V_0_vld_out, out_V_V_full_n, outPtr_V_out_full_n, ap_CS_fsm_state3, ap_CS_fsm_state2, tmp_i_i_fu_106_p2)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((real_start = ap_const_logic_0) or (outPtr_V_out_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (((tmp_i_i_fu_106_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_block_state1_assign_proc : process(real_start, ap_done_reg, outPtr_V_out_full_n)
    begin
                ap_block_state1 <= ((real_start = ap_const_logic_0) or (outPtr_V_out_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, tmp_i_i_fu_106_p2)
    begin
        if (((tmp_i_i_fu_106_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    i_fu_112_p2 <= std_logic_vector(unsigned(i_i_i_reg_95) + unsigned(ap_const_lv19_1));
    ...
    internal_ap_ready_assign_proc : process(ap_CS_fsm_state2, tmp_i_i_fu_106_p2)
    begin
        if (((tmp_i_i_fu_106_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    outPtr_V_out_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, outPtr_V_out_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            outPtr_V_out_blk_n <= outPtr_V_out_full_n;
        else 
            outPtr_V_out_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    outPtr_V_out_din <= outPtr_V;

    outPtr_V_out_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, outPtr_V_out_full_n)
    begin
        if ((not(((real_start = ap_const_logic_0) or (outPtr_V_out_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            outPtr_V_out_write <= ap_const_logic_1;
        else 
            outPtr_V_out_write <= ap_const_logic_0;
        end if; 
    end process;
    ...
    tmp_i_i_fu_106_p2 <= "1" when (i_i_i_reg_95 = ap_const_lv19_40000) else "0";
end behav;
