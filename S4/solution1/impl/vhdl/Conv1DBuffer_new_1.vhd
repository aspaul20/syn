...
architecture behav of Conv1DBuffer_new_1 is 
    ...
    signal exitcond_flatten3_reg_401 : STD_LOGIC_VECTOR (0 downto 0);
    signal ptr_simd_reg_139 : STD_LOGIC_VECTOR (8 downto 0);
    signal indvar_flatten3_reg_151 : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal exitcond_flatten3_fu_241_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state5_pp1_stage0_iter0 : BOOLEAN;
    signal ap_block_state6_pp1_stage0_iter1 : BOOLEAN;
    signal ap_block_pp1_stage0_11001 : BOOLEAN;
    signal indvar_flatten_next3_fu_247_p2 : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal tmp_18_fu_367_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp1_stage0_01001 : BOOLEAN;
    signal tmp_14_fu_223_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_16_fu_229_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_flatten_fu_253_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ofm_iter_fu_267_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_14_mid1_fu_273_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_cond_fu_235_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal not_exitcond_flatten_fu_287_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_42_fu_299_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_mid_fu_259_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_17_mid_fu_305_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_33_fu_325_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal nm_2_fu_319_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_14_mid2_fu_279_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_16_mid1_fu_339_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component Conv1DBuffer_new_hbi IS
    generic (
        DataWidth : INTEGER;
...
begin
    inputBuf_0_V_U : component Conv1DBuffer_new_hbi
    generic map (
        DataWidth => 8,
        AddressRange => 256,
        AddressWidth => 8)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((exitcond_flatten3_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten3_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                inputBuf_0_V_addr_1_reg_424 <= tmp_18_fu_367_p1(8 - 1 downto 0);
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, tmp_fu_206_p2, ap_enable_reg_pp0_iter0, exitcond_flatten3_fu_241_p2, ap_enable_reg_pp1_iter0, ap_block_pp0_stage0_subdone, ap_block_pp1_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp1_stage0 => 
                if (not(((exitcond_flatten3_fu_241_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif (((exitcond_flatten3_fu_241_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone))) then
    ...
    ap_block_pp1_stage0_01001_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten3_reg_401)
    begin
                ap_block_pp1_stage0_01001 <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten3_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp1_stage0_11001_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten3_reg_401)
    begin
                ap_block_pp1_stage0_11001 <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten3_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp1_stage0_subdone_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, ap_enable_reg_pp1_iter1, or_cond_mid2_reg_415, exitcond_flatten3_reg_401)
    begin
                ap_block_pp1_stage0_subdone <= ((ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (((exitcond_flatten3_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0))));
    end process;
    ...
    ap_block_state6_pp1_stage0_iter1_assign_proc : process(in_V_V_empty_n, out_V_V_full_n, or_cond_mid2_reg_415, exitcond_flatten3_reg_401)
    begin
                ap_block_state6_pp1_stage0_iter1 <= (((exitcond_flatten3_reg_401 = ap_const_lv1_0) and (out_V_V_full_n = ap_const_logic_0)) or ((or_cond_mid2_reg_415 = ap_const_lv1_1) and (in_V_V_empty_n = ap_const_logic_0)));
    end process;
    ...
    ap_condition_pp1_exit_iter0_state5_assign_proc : process(exitcond_flatten3_fu_241_p2)
    begin
        if ((exitcond_flatten3_fu_241_p2 = ap_const_lv1_1)) then 
    ...
    exitcond_flatten3_fu_241_p2 <= "1" when (indvar_flatten3_reg_151 = ap_const_lv24_800000) else "0";
    ...
    indvar_flatten_next3_fu_247_p2 <= std_logic_vector(unsigned(indvar_flatten3_reg_151) + unsigned(ap_const_lv24_1));
    ...
    inputBuf_0_V_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter0, tmp_s_fu_218_p1, tmp_18_fu_367_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
            inputBuf_0_V_address0 <= tmp_18_fu_367_p1(8 - 1 downto 0);
    ...
    nm_mid2_fu_359_p3 <= 
        nm_2_fu_319_p2 when (tmp_17_mid_fu_305_p2(0) = '1') else 
        nm_mid_fu_259_p3;
    nm_mid_fu_259_p3 <= 
    ...
    op1_assign_mid2_fu_311_p3 <= 
        ...
        op1_assign_reg_162;
    or_cond_fu_235_p2 <= (tmp_16_fu_229_p2 and tmp_14_fu_223_p2);
    or_cond_mid1_fu_345_p2 <= (tmp_16_mid1_fu_339_p2 and tmp_14_mid2_fu_279_p3);
    or_cond_mid2_fu_351_p3 <= 
        or_cond_mid1_fu_345_p2 when (tmp_17_mid_fu_305_p2(0) = '1') else 
        or_cond_mid_fu_293_p2;
    or_cond_mid_fu_293_p2 <= (or_cond_fu_235_p2 and not_exitcond_flatten_fu_287_p2);

    out_V_V_blk_n_assign_proc : process(out_V_V_full_n, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, ap_block_pp1_stage0, exitcond_flatten3_reg_401)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (exitcond_flatten3_reg_401 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
    ...
    out_V_V_write_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, exitcond_flatten3_reg_401, ap_block_pp1_stage0_11001)
    begin
        if (((exitcond_flatten3_reg_401 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
    ...
    ptr_simd4_mid2_fu_331_p3 <= 
        ap_const_lv9_0 when (tmp_33_fu_325_p2(0) = '1') else 
        ptr_simd4_reg_195;
    ...
    tmp_14_fu_223_p2 <= "1" when (unsigned(op1_assign_reg_162) < unsigned(ap_const_lv10_1FF)) else "0";
    tmp_14_mid1_fu_273_p2 <= "1" when (unsigned(ofm_iter_fu_267_p2) < unsigned(ap_const_lv10_1FF)) else "0";
    tmp_14_mid2_fu_279_p3 <= 
        tmp_14_mid1_fu_273_p2 when (exitcond_flatten_fu_253_p2(0) = '1') else 
        tmp_14_fu_223_p2;
    tmp_16_fu_229_p2 <= "1" when (nm_reg_184 = ap_const_lv7_3F) else "0";
    tmp_16_mid1_fu_339_p2 <= "1" when (nm_2_fu_319_p2 = ap_const_lv7_3F) else "0";
    tmp_17_mid_fu_305_p2 <= (tmp_42_fu_299_p2 and not_exitcond_flatten_fu_287_p2);
    tmp_18_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ptr_simd4_mid2_fu_331_p3),64));
    tmp_33_fu_325_p2 <= (tmp_17_mid_fu_305_p2 or exitcond_flatten_fu_253_p2);
    tmp_42_fu_299_p2 <= "1" when (ptr_simd4_reg_195 = ap_const_lv9_100) else "0";
