...
architecture behav of computeS4_4 is 
    ...
    signal FCMac_U0_out_V_V_din : STD_LOGIC_VECTOR (63 downto 0);
    signal FCMac_U0_out_V_V_write : STD_LOGIC;
    signal Relu1D_NP_U0_ap_start : STD_LOGIC;
    signal Relu1D_NP_U0_ap_done : STD_LOGIC;
    signal Relu1D_NP_U0_ap_continue : STD_LOGIC;
    signal Relu1D_NP_U0_ap_idle : STD_LOGIC;
    signal Relu1D_NP_U0_ap_ready : STD_LOGIC;
    signal Relu1D_NP_U0_start_out : STD_LOGIC;
    signal Relu1D_NP_U0_start_write : STD_LOGIC;
    signal Relu1D_NP_U0_in_V_V_read : STD_LOGIC;
    signal Relu1D_NP_U0_out_V_V_din : STD_LOGIC_VECTOR (63 downto 0);
    signal Relu1D_NP_U0_out_V_V_write : STD_LOGIC;
    ...
    signal fc1_V_V_full_n : STD_LOGIC;
    signal fc1_V_V_dout : STD_LOGIC_VECTOR (63 downto 0);
    signal fc1_V_V_empty_n : STD_LOGIC;
    signal fc2_V_V_full_n : STD_LOGIC;
    signal fc2_V_V_dout : STD_LOGIC_VECTOR (63 downto 0);
    signal fc2_V_V_empty_n : STD_LOGIC;
    signal fc3_V_V_full_n : STD_LOGIC;
    signal fc3_V_V_dout : STD_LOGIC_VECTOR (63 downto 0);
    signal fc3_V_V_empty_n : STD_LOGIC;
    ...
    signal start_for_Relu1D_NP_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Relu1D_NP_U0_full_n : STD_LOGIC;
    signal start_for_Relu1D_NP_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Relu1D_NP_U0_empty_n : STD_LOGIC;
    ...
    component start_for_Streamicpw IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Relu1D_cqw IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Streamicrw IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_ResizeScsw IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    Relu1D_NP_U0 : component Relu1D_NP
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    fc1_V_V_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    fc2_V_V_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    fc3_V_V_U : component fifo_w64_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Streamicpw_U : component start_for_Streamicpw
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Relu1D_cqw_U : component start_for_Relu1D_cqw
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Streamicrw_U : component start_for_Streamicrw
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_ResizeScsw_U : component start_for_ResizeScsw
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Relu1D_NP_U0_ap_start <= start_for_Relu1D_NP_U0_empty_n;
    ...
    ap_done <= ResizeStream_U0_ap_done;
    ap_idle <= (StreamingDataWidthCo_U0_ap_idle and StreamingDataWidthCo_1_U0_ap_idle and ResizeStream_U0_ap_idle and ResizeStream_1_U0_ap_idle and Relu1D_NP_U0_ap_idle and FCMac_U0_ap_idle);
    ap_ready <= ResizeStream_1_U0_ap_ready;
    ...
    start_for_Relu1D_NP_U0_din <= (0=>ap_const_logic_1, others=>'-');
