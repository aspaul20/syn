...
ResizeStream::ResizeStream(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, i_3_fu_78_p2, "i_3_fu_78_p2");
    sc_trace(mVcdFile, i_3_reg_92, "i_3_reg_92");
...
void ResizeStream::thread_i_3_fu_78_p2() {
    i_3_fu_78_p2 = (!i_reg_61.read().is_01() || !ap_const_lv6_1.is_01())? sc_lv<6>(): (sc_biguint<6>(i_reg_61.read()) + sc_biguint<6>(ap_const_lv6_1));
}
