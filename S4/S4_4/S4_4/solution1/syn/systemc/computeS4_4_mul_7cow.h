...
#ifndef __computeS4_4_mul_7cow__HH__
#define __computeS4_4_mul_7cow__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(computeS4_4_mul_7cow) {
    ...
    SC_CTOR(computeS4_4_mul_7cow):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
