...
reg   [23:0] indvar_flatten1_reg_151;
...
reg   [6:0] inputBuf_0_V_addr_2_reg_424;
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        inputBuf_0_V_addr_2_reg_424 <= tmp_112_fu_367_p1;
...
assign exitcond_flatten1_fu_259_p2 = ((indvar_flatten_reg_173 == 14'd4096) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_241_p2 = ((indvar_flatten1_reg_151 == 24'd8388608) ? 1'b1 : 1'b0);

assign indvar_flatten_next1_fu_247_p2 = (indvar_flatten1_reg_151 + 24'd1);

assign indvar_flatten_next_fu_384_p3 = ((exitcond_flatten1_fu_259_p2[0:0] === 1'b1) ? 14'd1 : indvar_flatten_op_fu_378_p2);

assign indvar_flatten_op_fu_378_p2 = (indvar_flatten_reg_173 + 14'd1);

assign nm_3_fu_319_p2 = (nm_mid_fu_265_p3 + 6'd1);

assign nm_mid2_fu_359_p3 = ((tmp_111_mid_fu_305_p2[0:0] === 1'b1) ? nm_3_fu_319_p2 : nm_mid_fu_265_p3);

assign nm_mid_fu_265_p3 = ((exitcond_flatten1_fu_259_p2[0:0] === 1'b1) ? 6'd0 : nm_reg_184);
...
assign ptr_simd4_mid2_fu_331_p3 = ((tmp_282_fu_325_p2[0:0] === 1'b1) ? 8'd0 : ptr_simd4_reg_195);
...
assign tmp_108_fu_223_p2 = ((op1_assign_reg_162 < 12'd2047) ? 1'b1 : 1'b0);

assign tmp_108_mid1_fu_273_p2 = ((ofm_iter_fu_253_p2 < 12'd2047) ? 1'b1 : 1'b0);

assign tmp_108_mid2_fu_279_p3 = ((exitcond_flatten1_fu_259_p2[0:0] === 1'b1) ? tmp_108_mid1_fu_273_p2 : tmp_108_fu_223_p2);

assign tmp_110_fu_229_p2 = ((nm_reg_184 == 6'd31) ? 1'b1 : 1'b0);

assign tmp_110_mid1_fu_339_p2 = ((nm_3_fu_319_p2 == 6'd31) ? 1'b1 : 1'b0);

assign tmp_111_mid_fu_305_p2 = (tmp_295_fu_299_p2 & not_exitcond_flatten_fu_287_p2);

assign tmp_112_fu_367_p1 = ptr_simd4_mid2_fu_331_p3;

assign tmp_282_fu_325_p2 = (tmp_111_mid_fu_305_p2 | exitcond_flatten1_fu_259_p2);

assign tmp_295_fu_299_p2 = ((ptr_simd4_reg_195 == 8'd128) ? 1'b1 : 1'b0);

assign tmp_fu_206_p2 = ((ap_phi_mux_ptr_simd_phi_fu_143_p4 == 8'd128) ? 1'b1 : 1'b0);

assign tmp_s_fu_218_p1 = ptr_simd_reg_139;

endmodule //Conv1DBuffer_new394
