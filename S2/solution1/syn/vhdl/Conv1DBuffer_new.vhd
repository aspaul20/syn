...
architecture behav of Conv1DBuffer_new is 
    ...
    signal inputBuf_0_V_addr_3_reg_424 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                inputBuf_0_V_addr_3_reg_424 <= tmp_118_fu_367_p1(7 - 1 downto 0);
    ...
    exitcond_flatten3_fu_259_p2 <= "1" when (indvar_flatten_reg_173 = ap_const_lv14_1000) else "0";
    exitcond_flatten_fu_241_p2 <= "1" when (indvar_flatten3_reg_151 = ap_const_lv24_800000) else "0";
    ...
    indvar_flatten_next1_fu_247_p2 <= std_logic_vector(unsigned(indvar_flatten3_reg_151) + unsigned(ap_const_lv24_1));
    indvar_flatten_next_fu_384_p3 <= 
        ap_const_lv14_1 when (exitcond_flatten3_fu_259_p2(0) = '1') else 
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
            inputBuf_0_V_address0 <= tmp_118_fu_367_p1(7 - 1 downto 0);
    ...
    nm_mid2_fu_359_p3 <= 
        nm_3_fu_319_p2 when (tmp_117_mid_fu_305_p2(0) = '1') else 
        nm_mid_fu_265_p3;
    nm_mid_fu_265_p3 <= 
        ap_const_lv6_0 when (exitcond_flatten3_fu_259_p2(0) = '1') else 
        nm_reg_184;
    ...
    ptr_simd4_mid2_fu_331_p3 <= 
        ap_const_lv8_0 when (tmp_284_fu_325_p2(0) = '1') else 
        ptr_simd4_reg_195;
    ...
    tmp_114_fu_223_p2 <= "1" when (unsigned(op1_assign_reg_162) < unsigned(ap_const_lv12_7FF)) else "0";
    tmp_114_mid1_fu_273_p2 <= "1" when (unsigned(ofm_iter_fu_253_p2) < unsigned(ap_const_lv12_7FF)) else "0";
    tmp_114_mid2_fu_279_p3 <= 
        tmp_114_mid1_fu_273_p2 when (exitcond_flatten3_fu_259_p2(0) = '1') else 
        tmp_114_fu_223_p2;
    tmp_116_fu_229_p2 <= "1" when (nm_reg_184 = ap_const_lv6_1F) else "0";
    tmp_116_mid1_fu_339_p2 <= "1" when (nm_3_fu_319_p2 = ap_const_lv6_1F) else "0";
    tmp_117_mid_fu_305_p2 <= (tmp_297_fu_299_p2 and not_exitcond_flatten_fu_287_p2);
    tmp_118_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ptr_simd4_mid2_fu_331_p3),64));
    tmp_284_fu_325_p2 <= (tmp_117_mid_fu_305_p2 or exitcond_flatten3_fu_259_p2);
    tmp_297_fu_299_p2 <= "1" when (ptr_simd4_reg_195 = ap_const_lv8_80) else "0";
