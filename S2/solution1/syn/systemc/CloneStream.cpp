...
CloneStream::CloneStream(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_7_fu_117_p2);
    sensitive << ( i_reg_100 );
    ...
    sc_trace(mVcdFile, i_7_fu_117_p2, "i_7_fu_117_p2");
...
void CloneStream::thread_i_7_fu_117_p2() {
    i_7_fu_117_p2 = (!i_reg_100.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(i_reg_100.read()) + sc_biguint<11>(ap_const_lv11_1));
}
...
void CloneStream::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if (!(esl_seteq<1,1,1>(tmp_fu_111_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter0.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_boolean_0, ap_block_pp0_stage0_subdone.read()))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(tmp_fu_111_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter0.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_boolean_0, ap_block_pp0_stage0_subdone.read()))) {
