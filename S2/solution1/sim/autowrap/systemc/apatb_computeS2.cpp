...
#define WRAPC_STREAM_SIZE_OUT_s2_out_V_V  "../tv/stream_size/stream_size_out_s2_out_V_V.dat"
#define WRAPC_STREAM_EGRESS_STATUS_s2_out_V_V  "../tv/stream_size/stream_egress_status_s2_out_V_V.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "outputGrp_V_V"
#define AUTOTB_TVOUT_PC_outputGrp_V_V  "../tv/rtldatafile/rtl.computeS2.autotvout_outputGrp_V_V.dat"
// tvout file define: "s2_out_V_V"
#define AUTOTB_TVOUT_PC_s2_out_V_V  "../tv/rtldatafile/rtl.computeS2.autotvout_s2_out_V_V.dat"
...
class INTER_TCL_FILE {
	public:
		...
		string get_depth_list () {
			...
			total_list << "{s2_out_V_V " << s2_out_V_V_depth << "}\n";
...
hls::stream<ap_uint<64> > (&s2_out))
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		// define output stream variables: "s2_out"
		std::vector<ap_uint<64> > aesl_tmp_9;
		int aesl_tmp_10;
		int aesl_tmp_11 = 0;

		// read output stream size: "s2_out"
		aesl_fh.read(WRAPC_STREAM_SIZE_OUT_s2_out_V_V, AESL_token); // [[transaction]]
		aesl_fh.read(WRAPC_STREAM_SIZE_OUT_s2_out_V_V, AESL_num); // transaction number

		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			aesl_fh.read(WRAPC_STREAM_SIZE_OUT_s2_out_V_V, AESL_token); // pop_size
		...
		// output port post check: "s2_out_V_V"
		aesl_fh.read(AUTOTB_TVOUT_PC_s2_out_V_V, AESL_token); // [[transaction]]
		if (AESL_token != "[[transaction]]")
		{
			exit(1);
		}
		aesl_fh.read(AUTOTB_TVOUT_PC_s2_out_V_V, AESL_num); // transaction number

		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			aesl_fh.read(AUTOTB_TVOUT_PC_s2_out_V_V, AESL_token); // data

			std::vector<sc_bv<64> > s2_out_V_V_pc_buffer;
			int i = 0;
			...
			while (AESL_token != "[[/transaction]]")
			{
				...
				while (!no_x)
				{
					...
					if (x_found != string::npos)
					{
						if (!err)
						{
							cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'X' on port 's2_out_V_V', possible cause: There are uninitialized variables in the C design." << endl;
							err = true;
						}
						AESL_token.replace(x_found, 1, "0");
					}
				...
				if (AESL_token != "")
				{
					s2_out_V_V_pc_buffer.push_back(AESL_token.c_str());
					i++;
				}

				aesl_fh.read(AUTOTB_TVOUT_PC_s2_out_V_V, AESL_token); // data or [[/transaction]]

				if (AESL_token == "[[[/runtime]]]" || aesl_fh.eof(AUTOTB_TVOUT_PC_s2_out_V_V))
				{
					exit(1);
				}
			}
			...
			if (i > 0)
			{
				// RTL Name: s2_out_V_V
				{
					// bitslice(63, 0)
					// {
						// celement: s2_out.V.V(63, 0)
						// {
							sc_lv<64>* s2_out_V_V_lv0_0_0_1 = new sc_lv<64>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					...
					// bitslice(63, 0)
					{
						...
						// celement: s2_out.V.V(63, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								{
									s2_out_V_V_lv0_0_0_1[hls_map_index].range(63, 0) = sc_bv<64>(s2_out_V_V_pc_buffer[hls_map_index].range(63, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(63, 0)
					{
						...
						// celement: s2_out.V.V(63, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								// output_type_conversion : (s2_out_V_V_lv0_0_0_1[hls_map_index]).to_string(SC_BIN).c_str()
								if (&(aesl_tmp_9[0]) != NULL) // check the null address if the c port is array or others
								{
									aesl_tmp_9[i_0] = (s2_out_V_V_lv0_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
									hls_map_index++;
								}
							}
						}
		...
		// push back output stream: "s2_out"
		for (int i = 0; i < aesl_tmp_10; i++)
		{
			s2_out.write(aesl_tmp_9[i]);
		}
	...
	else
	{
		...
		// "s2_out_V_V"
		char* tvin_s2_out_V_V = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_s2_out_V_V);
		char* tvout_s2_out_V_V = new char[50];
		aesl_fh.touch(AUTOTB_TVOUT_s2_out_V_V);
		char* wrapc_stream_size_out_s2_out_V_V = new char[50];
		aesl_fh.touch(WRAPC_STREAM_SIZE_OUT_s2_out_V_V);
		char* wrapc_stream_egress_status_s2_out_V_V = new char[50];
		aesl_fh.touch(WRAPC_STREAM_EGRESS_STATUS_s2_out_V_V);
		...
		// dump stream tvin: "s2_out"
		std::vector<ap_uint<64> > aesl_tmp_9;
		int aesl_tmp_10 = 0;
		while (!s2_out.empty())
		{
			aesl_tmp_9.push_back(s2_out.read());
			aesl_tmp_10++;
		}
...
// [call_c_dut] ---------->
		...
		computeS2(input1, inputGrp, outputGrp, s2_out);
     ...
     aesl_tmp_9.clear();
		...
		// [[transaction]]
		sprintf(tvout_s2_out_V_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVOUT_s2_out_V_V, tvout_s2_out_V_V);

		sc_bv<64>* s2_out_V_V_tvout_wrapc_buffer = new sc_bv<64>[aesl_tmp_10 - aesl_tmp_11];
			...
			// bitslice(63, 0)
			{
				...
				// celement: s2_out.V.V(63, 0)
				{
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						// sub_1st_elem          : 0
						// ori_name_1st_elem     : aesl_tmp_9[0]
						// regulate_c_name       : s2_out_V_V
						// input_type_conversion : (aesl_tmp_9[i_0]).to_string(2).c_str()
						if (&(aesl_tmp_9[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<64> s2_out_V_V_tmp_mem;
							s2_out_V_V_tmp_mem = (aesl_tmp_9[i_0]).to_string(2).c_str();
							s2_out_V_V_tvout_wrapc_buffer[hls_map_index].range(63, 0) = s2_out_V_V_tmp_mem.range(63, 0);
                                 	       hls_map_index++;
						}
					}
				}
		...
		{
			sprintf(tvout_s2_out_V_V, "%s\n", (s2_out_V_V_tvout_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVOUT_s2_out_V_V, tvout_s2_out_V_V);
		}

		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.s2_out_V_V_depth);
		sprintf(tvout_s2_out_V_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVOUT_s2_out_V_V, tvout_s2_out_V_V);

		// release memory allocation
		delete [] s2_out_V_V_tvout_wrapc_buffer;

		// dump stream size
		sprintf(wrapc_stream_size_out_s2_out_V_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(WRAPC_STREAM_SIZE_OUT_s2_out_V_V, wrapc_stream_size_out_s2_out_V_V);
		sprintf(wrapc_stream_size_out_s2_out_V_V, "%d\n", aesl_tmp_10 - aesl_tmp_11);
		aesl_fh.write(WRAPC_STREAM_SIZE_OUT_s2_out_V_V, wrapc_stream_size_out_s2_out_V_V);
		sprintf(wrapc_stream_size_out_s2_out_V_V, "[[/transaction]] \n");
		aesl_fh.write(WRAPC_STREAM_SIZE_OUT_s2_out_V_V, wrapc_stream_size_out_s2_out_V_V);
		...
		// release memory allocation: "s2_out_V_V"
		delete [] tvout_s2_out_V_V;
		delete [] tvin_s2_out_V_V;
		delete [] wrapc_stream_size_out_s2_out_V_V;
