...
if {[file isfile computeS2.autotvin.dat]} {
	file delete -force computeS2.autotvin.dat
}

if {[file isfile computeS2.autotvout.dat]} {
	file delete -force computeS2.autotvout.dat
}
