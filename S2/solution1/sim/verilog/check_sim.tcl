...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.computeS2.autotvin_input1_V_V.dat"
         "c.computeS2.autotvin_inputGrp_V_V.dat"
         "c.computeS2.autotvin_outputGrp_V_V.dat"
         "c.computeS2.autotvin_s2_out_V_V.dat"
         "c.computeS2.autotvout_outputGrp_V_V.dat"
         "c.computeS2.autotvout_s2_out_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.computeS2.autotvout_outputGrp_V_V.dat"
         "rtl.computeS2.autotvout_s2_out_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
