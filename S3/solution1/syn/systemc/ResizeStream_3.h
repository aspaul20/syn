...
#ifndef _ResizeStream_3_HH_
#define _ResizeStream_3_HH_
...
struct ResizeStream_3 : public sc_module {
    ...
    // Module declarations
    ResizeStream_3(sc_module_name name);
    SC_HAS_PROCESS(ResizeStream_3);
