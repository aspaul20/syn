...
void ResizeStream_1::thread_i_2_fu_78_p2() {
    i_2_fu_78_p2 = (!i_reg_61.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(i_reg_61.read()) + sc_biguint<11>(ap_const_lv11_1));
}
