...
const sc_logic ResizeStream_3::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic ResizeStream_3::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<3> ResizeStream_3::ap_ST_fsm_state1 = "1";
const sc_lv<3> ResizeStream_3::ap_ST_fsm_state2 = "10";
const sc_lv<3> ResizeStream_3::ap_ST_fsm_state3 = "100";
const sc_lv<32> ResizeStream_3::ap_const_lv32_0 = "00000000000000000000000000000000";
const sc_lv<1> ResizeStream_3::ap_const_lv1_0 = "0";
const sc_lv<1> ResizeStream_3::ap_const_lv1_1 = "1";
const sc_lv<2> ResizeStream_3::ap_const_lv2_0 = "00";
const sc_lv<2> ResizeStream_3::ap_const_lv2_2 = "10";
const sc_lv<2> ResizeStream_3::ap_const_lv2_3 = "11";
const sc_lv<2> ResizeStream_3::ap_const_lv2_1 = "1";
const sc_lv<32> ResizeStream_3::ap_const_lv32_2 = "10";
const sc_lv<32> ResizeStream_3::ap_const_lv32_1 = "1";
const sc_lv<11> ResizeStream_3::ap_const_lv11_0 = "00000000000";
const sc_lv<11> ResizeStream_3::ap_const_lv11_600 = "11000000000";
const sc_lv<11> ResizeStream_3::ap_const_lv11_1 = "1";
const bool ResizeStream_3::ap_const_boolean_1 = true;

ResizeStream_3::ResizeStream_3(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "ResizeStream_3_sc_trace_" << apTFileNum ++;
...
ResizeStream_3::~ResizeStream_3() {
    if (mVcdFile) 
        sc_close_vcd_trace_file(mVcdFile);

}

void ResizeStream_3::thread_ap_clk_no_reset_() {
...
void ResizeStream_3::thread_ap_CS_fsm_state1() {
    ap_CS_fsm_state1 = ap_CS_fsm.read()[0];
}

void ResizeStream_3::thread_ap_CS_fsm_state2() {
    ap_CS_fsm_state2 = ap_CS_fsm.read()[1];
}

void ResizeStream_3::thread_ap_CS_fsm_state3() {
    ap_CS_fsm_state3 = ap_CS_fsm.read()[2];
}

void ResizeStream_3::thread_ap_block_state1() {
    ap_block_state1 = (esl_seteq<1,1,1>(real_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1));
}

void ResizeStream_3::thread_ap_block_state3() {
...
void ResizeStream_3::thread_ap_done() {
...
void ResizeStream_3::thread_ap_idle() {
...
void ResizeStream_3::thread_ap_ready() {
    ap_ready = internal_ap_ready.read();
}

void ResizeStream_3::thread_i_1_fu_78_p2() {
...
void ResizeStream_3::thread_in_V_V_0_ack_in() {
    in_V_V_0_ack_in = in_V_V_0_state.read()[1];
}

void ResizeStream_3::thread_in_V_V_0_ack_out() {
    if ((!(esl_seteq<1,1,1>(in_V_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(out_V_V_full_n.read(), ap_const_logic_0)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
...
void ResizeStream_3::thread_in_V_V_0_data_out() {
...
void ResizeStream_3::thread_in_V_V_0_load_A() {
    in_V_V_0_load_A = (in_V_V_0_state_cmp_full.read() & ~in_V_V_0_sel_wr.read());
}

void ResizeStream_3::thread_in_V_V_0_load_B() {
    in_V_V_0_load_B = (in_V_V_0_sel_wr.read() & in_V_V_0_state_cmp_full.read());
}

void ResizeStream_3::thread_in_V_V_0_sel() {
    in_V_V_0_sel = in_V_V_0_sel_rd.read();
}

void ResizeStream_3::thread_in_V_V_0_state_cmp_full() {
...
void ResizeStream_3::thread_in_V_V_0_vld_in() {
    in_V_V_0_vld_in = in_V_V_TVALID.read();
}

void ResizeStream_3::thread_in_V_V_0_vld_out() {
    in_V_V_0_vld_out = in_V_V_0_state.read()[0];
}

void ResizeStream_3::thread_in_V_V_TDATA_blk_n() {
...
void ResizeStream_3::thread_in_V_V_TREADY() {
    in_V_V_TREADY = in_V_V_0_state.read()[1];
}

void ResizeStream_3::thread_internal_ap_ready() {
    if ((esl_seteq<1,1,1>(tmp_fu_72_p2.read(), ap_const_lv1_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
...
void ResizeStream_3::thread_out_V_V_blk_n() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
...
void ResizeStream_3::thread_out_V_V_din() {
    out_V_V_din = in_V_V_0_data_out.read().range(8-1, 0);
}

void ResizeStream_3::thread_out_V_V_write() {
    if ((!(esl_seteq<1,1,1>(in_V_V_0_vld_out.read(), ap_const_logic_0) || esl_seteq<1,1,1>(out_V_V_full_n.read(), ap_const_logic_0)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
...
void ResizeStream_3::thread_real_start() {
...
void ResizeStream_3::thread_start_out() {
    start_out = real_start.read();
}

void ResizeStream_3::thread_start_write() {
