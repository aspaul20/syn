...
reg   [24:0] indvar_flatten11_reg_151;
reg   [10:0] op1_assign_reg_162;
...
wire   [8:0] ptr_simd_3_fu_212_p2;
reg   [8:0] ptr_simd_3_reg_396;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] exitcond_flatten_fu_241_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [24:0] indvar_flatten_next1_fu_247_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [10:0] op1_assign_mid2_fu_311_p3;
wire   [0:0] or_cond_mid2_fu_351_p3;
wire   [6:0] nm_mid2_fu_359_p3;
reg   [7:0] inputBuf_0_V_addr_7_reg_424;
wire   [8:0] ptr_simd_4_fu_372_p2;
...
wire   [63:0] tmp_290_fu_367_p1;
reg    ap_block_pp1_stage0_01001;
wire   [0:0] tmp_287_fu_223_p2;
wire   [0:0] tmp_288_fu_229_p2;
wire   [0:0] exitcond_flatten11_fu_259_p2;
wire   [10:0] ofm_iter_fu_253_p2;
wire   [0:0] tmp_295_mid1_fu_273_p2;
wire   [0:0] or_cond_fu_235_p2;
wire   [0:0] not_exitcond_flatten_fu_287_p2;
wire   [0:0] tmp_895_fu_299_p2;
wire   [6:0] nm_mid_fu_265_p3;
wire   [0:0] tmp_298_mid_fu_305_p2;
wire   [0:0] tmp_875_fu_325_p2;
wire   [6:0] nm_4_fu_319_p2;
wire   [0:0] tmp_295_mid2_fu_279_p3;
wire   [0:0] tmp_297_mid1_fu_339_p2;
...
inputBuf_0_V_U(
    ...
    .d0(in_V_V_dout),
    .q0(inputBuf_0_V_q0),
    .address1(inputBuf_0_V_addr_7_reg_424),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        indvar_flatten11_reg_151 <= 25'd0;
        ...
        indvar_flatten11_reg_151 <= indvar_flatten_next1_fu_247_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_fu_241_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        inputBuf_0_V_addr_7_reg_424 <= tmp_290_fu_367_p1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        inputBuf_0_V_address0 = tmp_290_fu_367_p1;
...
assign exitcond_flatten11_fu_259_p2 = ((indvar_flatten_reg_173 == 16'd16384) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_241_p2 = ((indvar_flatten11_reg_151 == 25'd16777216) ? 1'b1 : 1'b0);

assign indvar_flatten_next1_fu_247_p2 = (indvar_flatten11_reg_151 + 25'd1);

assign indvar_flatten_next_fu_384_p3 = ((exitcond_flatten11_fu_259_p2[0:0] === 1'b1) ? 16'd1 : indvar_flatten_op_fu_378_p2);

assign indvar_flatten_op_fu_378_p2 = (indvar_flatten_reg_173 + 16'd1);

assign nm_4_fu_319_p2 = (nm_mid_fu_265_p3 + 7'd1);

assign nm_mid2_fu_359_p3 = ((tmp_298_mid_fu_305_p2[0:0] === 1'b1) ? nm_4_fu_319_p2 : nm_mid_fu_265_p3);

assign nm_mid_fu_265_p3 = ((exitcond_flatten11_fu_259_p2[0:0] === 1'b1) ? 7'd0 : nm_reg_184);

assign not_exitcond_flatten_fu_287_p2 = (exitcond_flatten11_fu_259_p2 ^ 1'd1);

assign ofm_iter_fu_253_p2 = (op1_assign_reg_162 + 11'd1);

assign op1_assign_mid2_fu_311_p3 = ((exitcond_flatten11_fu_259_p2[0:0] === 1'b1) ? ofm_iter_fu_253_p2 : op1_assign_reg_162);

assign or_cond_fu_235_p2 = (tmp_288_fu_229_p2 & tmp_287_fu_223_p2);

assign or_cond_mid1_fu_345_p2 = (tmp_297_mid1_fu_339_p2 & tmp_295_mid2_fu_279_p3);

assign or_cond_mid2_fu_351_p3 = ((tmp_298_mid_fu_305_p2[0:0] === 1'b1) ? or_cond_mid1_fu_345_p2 : or_cond_mid_fu_293_p2);

assign or_cond_mid_fu_293_p2 = (or_cond_fu_235_p2 & not_exitcond_flatten_fu_287_p2);

assign out_V_V_din = inputBuf_0_V_q0;

assign ptr_simd4_mid2_fu_331_p3 = ((tmp_875_fu_325_p2[0:0] === 1'b1) ? 9'd0 : ptr_simd4_reg_195);

assign ptr_simd_3_fu_212_p2 = (ap_phi_mux_ptr_simd_phi_fu_143_p4 + 9'd1);

assign ptr_simd_4_fu_372_p2 = (ptr_simd4_mid2_fu_331_p3 + 9'd1);

assign start_out = real_start;

assign tmp_287_fu_223_p2 = ((op1_assign_reg_162 < 11'd1023) ? 1'b1 : 1'b0);

assign tmp_288_fu_229_p2 = ((nm_reg_184 == 7'd63) ? 1'b1 : 1'b0);

assign tmp_290_fu_367_p1 = ptr_simd4_mid2_fu_331_p3;

assign tmp_295_mid1_fu_273_p2 = ((ofm_iter_fu_253_p2 < 11'd1023) ? 1'b1 : 1'b0);

assign tmp_295_mid2_fu_279_p3 = ((exitcond_flatten11_fu_259_p2[0:0] === 1'b1) ? tmp_295_mid1_fu_273_p2 : tmp_287_fu_223_p2);

assign tmp_297_mid1_fu_339_p2 = ((nm_4_fu_319_p2 == 7'd63) ? 1'b1 : 1'b0);

assign tmp_298_mid_fu_305_p2 = (tmp_895_fu_299_p2 & not_exitcond_flatten_fu_287_p2);

assign tmp_875_fu_325_p2 = (tmp_298_mid_fu_305_p2 | exitcond_flatten11_fu_259_p2);

assign tmp_895_fu_299_p2 = ((ptr_simd4_reg_195 == 9'd256) ? 1'b1 : 1'b0);

assign tmp_fu_206_p2 = ((ap_phi_mux_ptr_simd_phi_fu_143_p4 == 9'd256) ? 1'b1 : 1'b0);

assign tmp_s_fu_218_p1 = ptr_simd_reg_139;

endmodule //Conv1DBuffer_new396
