...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.computeS3.autotvin_input1_V_V.dat"
         "c.computeS3.autotvin_inputGrp_V_V.dat"
         "c.computeS3.autotvin_outputGrp_V_V.dat"
         "c.computeS3.autotvin_s3_out_V_V.dat"
         "c.computeS3.autotvout_outputGrp_V_V.dat"
         "c.computeS3.autotvout_s3_out_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.computeS3.autotvout_outputGrp_V_V.dat"
         "rtl.computeS3.autotvout_s3_out_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
