...
if {[file isfile computeS3.autotvin.dat]} {
	file delete -force computeS3.autotvin.dat
}

if {[file isfile computeS3.autotvout.dat]} {
	file delete -force computeS3.autotvout.dat
}
