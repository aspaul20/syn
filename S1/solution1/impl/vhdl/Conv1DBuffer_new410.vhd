...
architecture behav of Conv1DBuffer_new410 is 
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_241_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                inputBuf_0_V_addr_1_reg_424 <= tmp_112_fu_367_p1(6 - 1 downto 0);
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
            inputBuf_0_V_address0 <= tmp_112_fu_367_p1(6 - 1 downto 0);
    ...
    nm_mid2_fu_359_p3 <= 
        nm_4_fu_319_p2 when (tmp_111_mid_fu_305_p2(0) = '1') else 
        nm_mid_fu_265_p3;
    nm_mid_fu_265_p3 <= 
    ...
    ptr_simd4_mid2_fu_331_p3 <= 
        ap_const_lv7_0 when (tmp_365_fu_325_p2(0) = '1') else 
        ptr_simd4_reg_195;
    ...
    tmp_108_fu_223_p2 <= "1" when (unsigned(op1_assign_reg_162) < unsigned(ap_const_lv13_FFF)) else "0";
    tmp_108_mid1_fu_273_p2 <= "1" when (unsigned(ofm_iter_fu_253_p2) < unsigned(ap_const_lv13_FFF)) else "0";
    tmp_108_mid2_fu_279_p3 <= 
        tmp_108_mid1_fu_273_p2 when (exitcond_flatten1_fu_259_p2(0) = '1') else 
        tmp_108_fu_223_p2;
    tmp_110_fu_229_p2 <= "1" when (nm_reg_184 = ap_const_lv5_F) else "0";
    tmp_110_mid1_fu_339_p2 <= "1" when (nm_4_fu_319_p2 = ap_const_lv5_F) else "0";
    tmp_111_mid_fu_305_p2 <= (tmp_364_fu_299_p2 and not_exitcond_flatten_fu_287_p2);
    tmp_112_fu_367_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ptr_simd4_mid2_fu_331_p3),64));
    tmp_364_fu_299_p2 <= "1" when (ptr_simd4_reg_195 = ap_const_lv7_40) else "0";
    tmp_365_fu_325_p2 <= (tmp_111_mid_fu_305_p2 or exitcond_flatten1_fu_259_p2);
