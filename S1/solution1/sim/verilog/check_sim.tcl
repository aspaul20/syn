...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.computeS1.autotvin_hostmem.dat"
         "c.computeS1.autotvin_inPtr_V.dat"
         "c.computeS1.autotvin_s1_out_V_V.dat"
         "c.computeS1.autotvout_s1_out_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.computeS1.autotvout_s1_out_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
