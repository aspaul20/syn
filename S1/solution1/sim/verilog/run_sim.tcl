...
if {[file isfile computeS1.autotvin.dat]} {
	file delete -force computeS1.autotvin.dat
}

if {[file isfile computeS1.autotvout.dat]} {
	file delete -force computeS1.autotvout.dat
}
