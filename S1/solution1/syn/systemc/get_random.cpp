...
get_random::get_random(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_cast_31_fu_160_p1 );
    ...
    SC_METHOD(thread_tmp_cast_31_fu_160_p1);
    ...
    sc_trace(mVcdFile, tmp_cast_31_fu_160_p1, "tmp_cast_31_fu_160_p1");
...
void get_random::thread_ap_return_0() {
    ap_return_0 = tmp_cast_31_fu_160_p1.read();
}
...
void get_random::thread_tmp_cast_31_fu_160_p1() {
    tmp_cast_31_fu_160_p1 = esl_zext<32,12>(tmp_cast_fu_154_p2.read());
}
